...
export function OpportunityCard({ opp, onSave }: { opp: OpportunityView; onSave: (id: string, status: string) => void }) {
  ...
  return <article className="surface flex h-full flex-col p-5 transition-all duration-200 ease-out hover:-translate-y-1 hover:shadow-lg hover:border-slate-300">
